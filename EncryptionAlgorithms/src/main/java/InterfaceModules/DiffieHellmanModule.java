...
public class DiffieHellmanModule extends AbstractModule {
    ...
    public DiffieHellmanModule(JPanel panel){
        ...
        xa = new JLabel("xa=?");
        xa.setPreferredSize(new Dimension(50, 25));
        panel.add(xa);

        xb = new JLabel("xb=?");
        xb.setPreferredSize(new Dimension(50, 25));
        panel.add(xb);

        ya = new JLabel("ya=?");
        ya.setPreferredSize(new Dimension(50, 25));
        panel.add(ya);

        yb = new JLabel("yb=?");
        yb.setPreferredSize(new Dimension(50, 25));
        panel.add(yb);

        zab = new JLabel("zab=?");
        zab.setPreferredSize(new Dimension(50, 25));
        panel.add(zab);

        zba = new JLabel("zba=?");
        zba.setPreferredSize(new Dimension(50, 25));
        panel.add(zba);
    }
