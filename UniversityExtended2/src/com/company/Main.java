...
//        StudentCreator studentCreator = new StudentCreator();
        ...
        DisciplineCreator.createFromFile("disciplines.txt");
        ProfessorCreator.createFromFile( "professors.txt");
        StudentCreator.createFromFile( "students.txt");
        System.out.println(Discipline.getDisciplines());
        System.out.println(Professor.getProfessors());
        ...
        try (BufferedReader br = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            Student studentFromConsole = getStudentByName(studentName, Student.getStudents());
            studentFromConsole.learn();

            System.out.println("Enter professorName");
            String professorName = br.readLine();
            Professor professorFromConsole = getProfessorByName(professorName, Professor.getProfessors());
